...
const App: React.FC = () => {
  ...
  const renderLobby = () => {
    if (!room) return null;
    return (
      <div className="max-w-2xl mx-auto p-4 md:p-8 relative z-10 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-500">
        {/* Header */}
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] w-full p-4 relative animate-in fade-in zoom-in duration-300">
        <button 
          ...
          className="absolute top-4 left-4 md:top-8 md:left-8 text-slate-400 hover:text-white flex items-center gap-2 px-4 py-2 rounded-full hover:bg-white/5 transition-all"
        >
          ← Volver
        </button>
